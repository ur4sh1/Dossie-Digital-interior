<template>
    <div class="container">
        ...
        <div class="row table-responsive-sm" style="background:lavenderblush">
            <div class="col-sm-6">
                <label style="color: #1b1e21"><b>ITEM</b></label>
            </div>
            <div class="col-sm-2 text-right">
                <label><b>{{anoatual-3}}</b></label>
            </div>
            <div class="col-sm-2 text-right">
        ...
        <div class="row" v-for="ire in itemrecursoestadual">
            ...
            <div class="col-2">
                <span v-for="a in ano">
                    <div class="text-right" v-for="re in recursoestadual" v-if="re.item_recurso_estadual_id===ire.id && re.ano_id===a.id && a.ano===anoatual-3">
                        <a class="link" v-on:click="editaValor(re.id,re.valor,re.item_recurso_estadual_id,re.ano_id)">{{re.valor}}</a>
                    </div>
                </span>
            </div>
            <div class="col-2">

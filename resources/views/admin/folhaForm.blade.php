        ...
        <form method="post" action="{{route('folhas.store')}}">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="text" class="text-right" name="salario_inicial" id="salario_inicial" value="" required>
                </div>
                <div class="col">
                    <label for="SUSAM">SUSAM</label><br>
                    <input type="text" class="text-right" style="width: 50px" name="SUSAM" id="SUSAM" value="" required>
                </div>
            </div>
            <div class="row">

            ...
            @foreach($programas as $p)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-primary btn-sm mr-1 ml-1" title="EDITAR" href="{{route('programas.edit',$p)}}" role="button"><span class="fa fa-edit"></span></a>
                            <form action="{{route('programas.destroy',$p)}}" method="post" class="mr-1 ml-1">
                                @csrf
                                @method('delete')

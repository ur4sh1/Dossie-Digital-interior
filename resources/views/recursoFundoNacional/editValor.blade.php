        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="form-col-2">
                    ...
                    <input class="form-control text-right" onkeypress="isNumberKeyCurrency(event)" value="{{ number_format($recursoFundoNacional->valor,2,',','.') }}" id="valor" name="valor" required>
                </div>
                <div class="form-col-2">

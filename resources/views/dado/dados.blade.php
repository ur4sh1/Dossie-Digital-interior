        ...
        <div class="text-right mb-2">
            ...
            <div class="row mt-4">
                <div class="col-sm-4 mt-2">
                    ...
                    Atualizado em: <input type="text" disabled value="{{$detalhes->pop_plan_saude_ano}}" class="form-control" style="width: 80px" name="pop_plan_saude_ano" id="pop_plan_saude_ano">
                </div>
                <div class="col-sm-4 mt-2">
                    ...
                    Atualizado em: <input type="text" disabled value="{{$detalhes->pop_extr_pobreza_ano}}" class="form-control" style="width: 80px" name="pop_extr_pobreza_ano" id="pop_extr_pobreza_ano">
                </div>
            </div>
            <div class="row mt-4">
                <div class="col">
